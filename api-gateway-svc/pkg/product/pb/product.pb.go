...
func (x *DecreaseStockRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DecreaseStockRequest) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *DecreaseStockRequest) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0x56, 0x0a, 0x14, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x53, 0x74,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x45, 0x0a, 0x15, 0x44, 0x65,
